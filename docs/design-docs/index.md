...
> Сюда попадают design-документы: контекст решения, рассмотренные варианты,
> принятое направление и trade-off'ы. Один документ = одно крупное
> архитектурное решение или feature-архитектура.
...
| [WALL-BRIGHTNESS-PERF.md](./WALL-BRIGHTNESS-PERF.md) | Визуализатор · перф `computeWallBrightness` + селекторы | draft |
| [product-page-usage-examples.md](./product-page-usage-examples.md) | Product page · usage | reference |

Статусы: `draft` (в работе) · `approved` (внедрено) · `reference` (справочный) · `archived` (история).
