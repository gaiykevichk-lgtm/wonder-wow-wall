		...
		<Drawer
			title={
				...
				>
					...
					{items.length > 0 && (
						<Button type="text" size="small" danger onClick={clearCart}>
							Очистить
						</Button>
					)}
				</div>
			...
			{items.length === 0 ? (
				...
				<>
					...
					>
						...
						>
							<span style={{ fontSize: 16, fontWeight: 500, color: "#2D2D2D" }}>
								Итого:
							</span>
							<span style={{ fontSize: 22, fontWeight: 600, color: "#2D2D2D" }}>
