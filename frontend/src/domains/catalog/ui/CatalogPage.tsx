		...
		<div style={{ paddingTop: 72, minHeight: "100vh", background: "#FFFFFF" }}>
			...
			<div style={{ background: "#F5F5F5", padding: "100px 40px 80px" }}>
				<div style={{ maxWidth: 1080, margin: "0 auto", textAlign: "center" }}>
					...
					>
						Мы убрали цвет и фактуры, чтобы Вы увидели главное — форму. Текстуру
						и Характер мы добавим на следующем шаге.
					</p>
				</div>
			</div>

			<div
				style={{ maxWidth: 1080, margin: "0 auto", padding: "40px 40px 80px" }}
			>
				{/* Search */}
				<div
					style={{
	...
	return (
		<motion.div
			...
			style={{
				...
				background: "#FAFAFA",
				transition:
					"box-shadow 0.5s cubic-bezier(0.25, 0.1, 0.25, 1.0), transform 0.5s cubic-bezier(0.25, 0.1, 0.25, 1.0)",
				boxShadow: hovered
				...
				{product.badge && (
					<span
						style={{
							...
							top: 16,
							left: 16,
							background: product.badge === "Новинка" ? "#4CAF50" : "#2D2D2D",
							color: "#FFFFFF",
							borderRadius: 10,
							fontWeight: 600,
							fontSize: 12,
