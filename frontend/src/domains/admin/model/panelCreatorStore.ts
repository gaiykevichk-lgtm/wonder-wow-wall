...
export const PANEL_SIZES: Array<{ key: PanelSizeKey; label: string; width: number; height: number }> = [
...
function makeVariantKey(textureId: string, colorId: string, sizeKey: PanelSizeKey): string {
