...
const faqItems = [
	{
		...
		children: (
			...
			>
				Стандартная комната 16–20 м² занимает около 2–3 часов. Если у вас
				сложная геометрия стен или нестандартные проёмы, мастер может
				задержаться немного дольше. Точное время мы озвучим при согласовании
				визита.
			</p>
		),
	},
	{
		...
		children: (
			...
			>
				Стены должны быть сухими, без выраженных перепадов более 5 мм.
				Незначительные неровности мастер исправит в процессе монтажа. Свежую
				штукатурку нужно выдержать не менее 28 дней перед установкой панелей.
			</p>
		),
	},
	{
		...
		children: (
			...
			>
				Да, наша система крепления позволяет демонтировать панели без
				повреждения стены и поверхности панели. При переезде или редизайне вы
				можете взять панели с собой и установить в новом месте.
			</p>
		),
	},
	{
		...
		children: (
			...
			>
				Большинство панелей достаточно протирать влажной тряпкой или
				микрофиброй. Не используйте абразивные средства и растворители.
				Деревянные панели рекомендуется раз в год обрабатывать специальным
				воском для дерева.
			</p>
		),
	},
...
const HowItWorksPage: React.FC = () => (
	<div style={{ fontFamily: FONT, paddingTop: 72 }}>
		<PageMeta
			...
			description="Узнайте как работает сервис модульной отделки стен Wonder Wow Wall."
		/>
		{/* Hero */}
		<section style={{ background: "#F5F5F5", padding: "120px 24px 120px" }}>
			<div style={{ ...MAX_WIDTH, textAlign: "center" }}>
				...
				>
					...
					>
						Мы убрали всё лишнее: сложные расчёты, поиск подрядчиков,
						строительный мусор и недели ожидания. Вы выбираете дизайн. Всё
						остальное уже предусмотрено WONDER WOW WALL.
					</motion.p>
				</motion.div>
			</div>
		</section>
		...
		<section style={{ background: "#F5F5F5", ...SECTION_PAD }}>
			<div style={{ ...MAX_WIDTH }}>
				...
				>
					...
					>
						Короткое видео о процессе установки панелей — от распаковки до
						результата.
					</motion.p>
					<motion.div
						variants={fadeUp}
